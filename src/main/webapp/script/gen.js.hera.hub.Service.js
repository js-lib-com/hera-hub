...
js.hera.hub.Service = {
	 ...
	 * Upload icon.
	 *
	 * @param js.http.form.UploadedFile icon,
	 * @param Function callback function to invoke on RMI completion,
	 * @param Object scope optional callback run-time scope, default to global scope.
	 * @return void
	 ...
	 * Create action.
	 *
	 * @param js.hera.auto.engine.SourceCode sourceCode,
	 * @param Function callback function to invoke on RMI completion,
	 * @param Object scope optional callback run-time scope, default to global scope.
	 * @return void
	 * @throws java.io.IOException
	 ...
	 * @note since method return type is void, callback, and hence scope too, is optional.
	 */
	 createAction: function(sourceCode) {
		$assert(typeof sourceCode !== "undefined", "js.hera.hub.Service#createAction", "Source code argument is undefined.");

		var __callback__ = arguments[1];
		$assert(typeof __callback__ === "undefined" || js.lang.Types.isFunction(__callback__), "js.hera.hub.Service#createAction", "Callback is not a function.");
		var __scope__ = arguments[2];
		$assert(typeof __scope__ === "undefined" || js.lang.Types.isObject(__scope__), "js.hera.hub.Service#createAction", "Scope is not an object.");
		if(!js.lang.Types.isObject(__scope__)) {
			__scope__ = window;
		}

		var rmi = new js.net.RMI();
		rmi.setMethod("js.hera.hub.Service", "createAction");
		rmi.setParameters(sourceCode);
		rmi.exec(__callback__, __scope__);
	},
	 ...
	 */
	 createRule: function(rule) {
		$assert(typeof rule !== "undefined", "js.hera.hub.Service#createRule", "Rule argument is undefined.");

		var __callback__ = arguments[1];
		$assert(typeof __callback__ === "undefined" || js.lang.Types.isFunction(__callback__), "js.hera.hub.Service#createRule", "Callback is not a function.");
		var __scope__ = arguments[2];
		$assert(typeof __scope__ === "undefined" || js.lang.Types.isObject(__scope__), "js.hera.hub.Service#createRule", "Scope is not an object.");
		if(!js.lang.Types.isObject(__scope__)) {
			__scope__ = window;
		}

		var rmi = new js.net.RMI();
		rmi.setMethod("js.hera.hub.Service", "createRule");
	 ...
	 * @assert callback is a {@link Function} and scope is an {@link Object}.
	 */
	 getActionClassNames: function() {
		var __callback__ = arguments[0];
		$assert(js.lang.Types.isFunction(__callback__), "js.hera.hub.Service#getActionClassNames", "Callback is not a function.");
		var __scope__ = arguments[1];
		$assert(typeof __scope__ === "undefined" || js.lang.Types.isObject(__scope__), "js.hera.hub.Service#getActionClassNames", "Scope is not an object.");
		if(!js.lang.Types.isObject(__scope__)) {
			__scope__ = window;
		}

		var rmi = new js.net.RMI();
		rmi.setMethod("js.hera.hub.Service", "getActionClassNames");
		rmi.exec(__callback__, __scope__);
	},
	 ...
	 * @assert callback is a {@link Function} and scope is an {@link Object}.
	 */
	 getSourceCode: function(className) {
		$assert(typeof className !== "undefined", "js.hera.hub.Service#getSourceCode", "Class name argument is undefined.");
		$assert(className === null || js.lang.Types.isString(className), "js.hera.hub.Service#getSourceCode", "Class name argument is not a string.");

		var __callback__ = arguments[1];
		$assert(js.lang.Types.isFunction(__callback__), "js.hera.hub.Service#getSourceCode", "Callback is not a function.");
		var __scope__ = arguments[2];
		$assert(typeof __scope__ === "undefined" || js.lang.Types.isObject(__scope__), "js.hera.hub.Service#getSourceCode", "Scope is not an object.");
		if(!js.lang.Types.isObject(__scope__)) {
			__scope__ = window;
		}

		var rmi = new js.net.RMI();
		rmi.setMethod("js.hera.hub.Service", "getSourceCode");
