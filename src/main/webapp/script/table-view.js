 ...
 * 
 * <pre>
 *   &lt;table data-ref="lib/table-view" data-cfg="order-by:true;page-size:20;"&gt;
 *      &lt;tr data-inject="heading"&gt;
 *          &lt;td&gt;ID&lt;/td&gt;
 *          &lt;td&gt;Name&lt;/td&gt;
 *          &lt;td&gt;Birth Date&lt;/td&gt;
 *      &lt;/tr&gt;
 *      &lt;tr data-inject="content"&gt;
 *          &lt;td data-text="id"&gt;&lt;/td&gt;
 *          &lt;td data-text="name"&gt;&lt;/td&gt;
 *          &lt;td data-text="birthDate" data-format="js.format.ShortDate"&gt;&lt;/td&gt;
 *      &lt;/tr&gt;
 *      &lt;tr data-inject="paging"&gt;
 *          &lt;td data-ref="lib/table-paging"&gt;&lt;/td&gt;
 *      &lt;/tr&gt;
 *   &lt;/table&gt;
 * </pre>
 * 
...
js.widget.TableView = function (ownerDoc, node) {
    ...
    var masterCheckboxTD = ownerDoc.createElement("td");
    ...
    this._events.register("selection-update", "items-loaded");
...
js.widget.TableView.prototype = {
     ...
     * @type String
     */
    _ORDER_BY_ICON : "/hera/media/lib-table-view_order-by-icon.png",
    ...
    _onClick : function (ev) {
        var td, checkbox, it, value, orderByIcon;
        ...
        if (ev.target.hasCssClass(this._CSS_ITEM_SELECTOR)) {
            ...
            if (checkbox.hasCssClass(this._CSS_MASTER_SELECTOR)) {
                ...
                if (checkbox.checked()) {
                    while (it.hasNext()) {
                        this._selectedValues.push(it.next().check().getParentByTag("tr").addCssClass(this._CSS_SELECTED).getUserData());
                    }
                }
                else {
                    while (it.hasNext()) {
                        it.next().uncheck().getParentByTag("tr").removeCssClass(this._CSS_SELECTED);
                    }
                }
                this._events.fire("selection-update", this._selectedValues);
                return;
    ...
    _load : function (pageIndex) {
        ...
        if (this._config.orderBy) {
            request.orderBy = {
                ...
                direction : this._currentColumnHeader.getByTag("img").hasCssClass(this._CSS_DESC) ? "DESC" : "ASC"
            }
        }
        else {
            request.orderBy = {};
